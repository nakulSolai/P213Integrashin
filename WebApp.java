...
public class WebApp {
  ...
  private static String generateResponseHTML(
        Map<String,String> keyValuePairs, FrontendInterface frontend) {
    ...
    if (keyValuePairs.containsKey("start") && keyValuePairs.containsKey("end")) {
      ...
      response += frontend.generateReachableFromWithinResponseHTML( keyValuePairs.get("from"),
