...
public class P210SubmissionChecker extends DijkstraGraph<Integer, Integer> {
  ...
  public void submissionCheckerSmallGraph() {
    ...
    assertEquals(7, graph.shortestPathCost(6, 11));
    assertEquals("[6, 11]", graph.shortestPathData(6, 11).toString());
  }
  ...
  public void submissionCheckerNoPath() {
    ...
    assertThrows(NoSuchElementException.class, () -> graph.computeShortestPath("B", "A"));
  }
  ...
  public void submissionCheckerNoNode() {
    ...
    assertThrows(NoSuchElementException.class, () -> graph.computeShortestPath("X", "A"));
  }
